...
public class LoadingImageView extends FrameLayout {
    ...
    public LoadingImageView(Context context, Indicator indicator, String defaulterror) {
        super(context);
        this.indicator=indicator;
        this.defaulterror=defaulterror;
        init();
    }
    public LoadingImageView(Context context, Indicator indicator) {
        super(context);
        this.indicator=indicator;
        init();
    }
...
//        removeAllViews();
        ...
        imageView.setBackgroundColor(LOADING_IMAGE_VIEW_BACKGROUND);
